...
**
*******************************************************************************
** $Archive: /Projects/Tigris and Derivatives/Reference Designs/Tigris/Linux/Kernel Driver/DevIoBufMgmt.h $
** $Revision: 1 $
** $Date: 1/09/01 10:54a $
*******************************************************************************
******************************************************************************/
/**/	//This is a Page Eject character.
#ifndef _DEVIOBUFMGMT_H_
#define _DEVIOBUFMGMT_H_
...
/**/	//This is a Page Eject character.
//////////////////////////////////////////////
//	BufMgmt Module BackDoor Definitions
//////////////////////////////////////////////

// **************************************************
//	Parameters:	xxx->ReqCode = BD_BUFMGMT_GET_CONFIG
//	Response:	xxx->ResultCode = BD_RESULT_SUCCESS, etc.
//				xxx->Params.BdBufMgmtConfig.RxMaxFrameSize = ZZ1
//				xxx->Params.BdBufMgmtConfig.TxMaxFrameSize = ZZ2
//
// **************************************************
//	Parameters:	xxx->ReqCode = BD_BUFMGMT_SET_CONFIG
//				xxx->Params.BdBufMgmtConfig.RxMaxFrameSize = ZZ1
//				xxx->Params.BdBufMgmtConfig.TxMaxFrameSize = ZZ2
//	Response:	xxx->ResultCode = BD_RESULT_SUCCESS, etc.
//
...
typedef struct BD_BUFMGMT_CFG_S
{
...
#define DEVIO_BUFMGMT_STRUC_UNION												\
	BD_BUFMGMT_CFG_T			BdBufMgmtConfig;								\
...
#define DEVIO_BUFMGMT_REQ_CODES											\
	BD_BUFMGMT_START_CODE = BD_BUFMGMT_CODES,							\
	BD_BUFMGMT_GET_CONFIG,							/* 0x00030001 */	\
	BD_BUFMGMT_SET_CONFIG,												\
	BD_BUFMGMT_END_CODE,												\
